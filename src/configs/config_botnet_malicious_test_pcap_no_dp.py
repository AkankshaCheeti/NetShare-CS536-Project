...
for alias in ["ugr16", "cidds", "ton", "caida", "dc", "ca", "botnet_benign", "botnet_malicious"]:
...
config = {
	"scheduler_config": {
        "result_root_folder": "../results/results_botnet_malicious_pcap_no_dp",
