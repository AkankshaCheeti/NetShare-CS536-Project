    ...
    # for dataset in ["cidds", "ton"]:
        ...
        for method in ["NetShare"]:
            ...
            for synid in range(1):
                ...
                plot_cdf(raw_df, {"NetShare":syn_df}, "# of records with the same five tuple", "CDF", result_baseDir, "flow_size")
...
def run_netflow_qualitative_plots():
    ...
    # for dataset in ["ugr16"]:
        ...
        # for method in ["CTGAN"]:
            ...
            #     file_type=dataset
            # )
            syn_df = pd.read_csv(os.path.join(dataset, method, "syn1.csv"))
