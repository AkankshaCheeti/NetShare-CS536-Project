...
python3 word2vec_embedding.py --src_dir ../data/1M/botnet_benign_flow --word_vec_size 10 --file_type BOTNET_FLOW
python3 preprocess_by_type.py --src_dir ../data/1M/botnet_benign_flow --word2vec_vecSize 10 --file_type BOTNET_FLOW --split_name multiepoch_dep_v2 --df2epochs fixed_time --n_instances 10 --netflow_interarrival
